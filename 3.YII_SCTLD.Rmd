...
# Final model
LM_1 <- lmer(YII ~ Nutrients + Temperature + (1 | Genotype),  data=YII.Tall)
summary(LM_1)
anova(LM_1)
ranova(LM_1)
...
plot(Effect(c("Nutrients","Temperature"), LM_1), x.var="Temperature", multiline=T, ci.style="bars")

#  Pair-wise comparisons
YIIAcerEmm<-cld(emmeans(LM_1, specs = c("Nutrients", "Temperature")))
YIIAcerEmm
write.csv(YIIAcerEmm, "Outputs/YIIAcerEmm.csv")
...
YII_Trea<- ggplot(YII.Tall, 
                  aes (as.factor(Temperature), YII, colour=factor(N_T))) +
  Treat_fill+
  Treat_colour+
