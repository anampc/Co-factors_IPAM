...
# Import YII data: 
      ...
      #YII.Tall<-YII.Tall[which(YII.Tall$TimePoint!="T-1"),]
...
YII_Nutrients<- ggplot(YII.Tall, aes (TimePoint, YII, colour=Nutrients)) +
  #stat_summary(fun.y=mean, geom = "line")+ theme_classic() +
  geom_jitter(aes(fill=Nutrients, shape=Temperature),alpha=0.5) + MyTheme+
  stat_summary(fun.data = "mean_cl_boot",
               geom = "errorbar", width = 0.2 ) +
  ylim(0.25, 0.75)
YII_Nutrients + facet_grid(~Genotype)
...
YII_T3<- ggplot(YII.Tall[YII.Tall$TimePoint=="T3", ], aes (Genotype, YII, 
                              colour=factor(Temp), shape=Nutrients)) +
  #stat_summary(fun.y=mean, geom = "line")+ theme_classic() +
  geom_jitter(aes(shape=Nutrients), alpha=0.4) + MyTheme+
  stat_summary(fun.data = "mean_cl_boot",
...
```{r}
YII_Trea<- ggplot(YII.Tall[YII.Tall$TimePoint!="T0", ], 
...
YII_Trea<- ggplot(YII.Tall[YII.Tall$TimePoint!="T0", ], 
  ...
  # scale_x_date(date_breaks = "1 week", 
  #              date_labels = "%b/%d")+
YII_Trea + ylim(0.55, 0.71)+facet_grid(~Genotype)

library(lattice)
xyplot(YII ~ TimePoint | Nutrients, data=YII.Tall, type=c("p", "r"), ylim=c(0.0, 0.7))
```
