...
```{r}
        ...
        # NewData <- expand.grid(TimePoint=unique(YII.Tall$TimePoint),
        #                        Nutrients=unique(YII.Tall$Nutrients),
        #                        Temperature=unique(YII.Tall$Temperature),
        #                         Genotype=unique(YII.Tall$Genotype))
        # # get prediction
        # pred <- predict(LM_1, newdata= NewData, se.fit=TRUE, type = "response")
        # 
        # # CI function
